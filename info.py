...
USERNAME = environ.get('USERNAME', "https://telegram.me/I_Am_MrAK")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002145921498').split()]
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002141251057'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002223436923'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002141251057'))
URL = environ.get('URL', 'www.mraklinkzz.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002141251057'))
...
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'publicearn.online')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002146500872')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002141251057'))
